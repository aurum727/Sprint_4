...
class MainPage(BasePage):
    ...
    @allure.step('Получаем ответ на вопрос по его порядковому номер начиная с нуля {question_number}')
    def get_answer_for_question_by_number(self, question_number):
        method, locator = MainPageLocators.QUESTION_BY_NUMBER
        question_locator = method, locator.format(question_number)
        ...
        answer_locator = method, locator.format(question_number)
